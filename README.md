...
Use this email for an admin testing account with unlimited coins:

- Email: admin@farmfintech.test

How to use:

1. Register this email from the login screen (any password).
2. Log in using the same email.
3. The account is automatically promoted to admin and gets unlimited cash/bank balance.

You can change the admin whitelist in [lib/config/constants.dart](lib/config/constants.dart).
---
